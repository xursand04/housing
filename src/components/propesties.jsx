...
const Properties = () => {
    return(
        <>
        <Box sx={{textAlign:"center",marginBottom:"100px",marginTop:'100px'}}>
            <Typography variant="h2">Properties</Typography>
            <Typography variant="h5" sx={{color:'gray'}}>Nulla quis curabitur velit volutpat auctor bibendum consectetur sit.</Typography>
        </Box>
        <center>

        <Grid container spacing={3} sx={{marginBottom:'100px'}}>
            <Grid item xs={12} lg={6} xl={4} >
            <Box sx={{border:'1px solid gray',width:'380px',height:'505px',padding:'10px'}}>
